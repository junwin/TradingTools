...
namespace K2DataObjects
{
    ...
    public class Exchange : KaiTrade.Interfaces.IExchange
    {
        ...
        [DataMember]
        [JsonProperty]
        [global::System.Data.Linq.Mapping.ColumnAttribute(Name = "[ExchangeCode]", Storage = "m_ExchangeCode", DbType = "NVarChar(255) NOT NULL", CanBeNull = false, IsPrimaryKey = true)]
