...
namespace KaiTrade.Interfaces
{
    ...
    public interface OrderManager
    {
        ...
        /// </summary>
        /// <returns></returns>
        KaiTrade.Interfaces.Order CreateOrder();
        ...
        /// </summary>
        /// <param name="?"></param>
        void RegisterOrder(KaiTrade.Interfaces.Order myOrder);
        ...
        void AssociateClOrdID(string myClOrdID, Order myOrder);
        ...
        /// <returns></returns>
        KaiTrade.Interfaces.Order GetOrder(string myOrderID);
        ...
        /// <returns></returns>
        KaiTrade.Interfaces.Order GetOrderWithClOrdIDID(string myID);
        ...
        bool RecordExecutionReport(string myID, QuickFix.Message myExecRep);
    }
}
